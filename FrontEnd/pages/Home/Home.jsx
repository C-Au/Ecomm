    ...
    const products = [
        {
            ...
            name: "Wireless Mouse",
            price: 19.99,
            description: "A smooth and responsive wireless mouse for everyday computer use.",
        ...
        },
        {
            ...
            name: "Phone Stand",
            price: 6.99,
            description: "A sturdy stand that holds your phone upright for easy viewing.",
        ...
        },
        {
            ...
            name: "Desk Lamp",
            price: 24.99,
            description: "An adjustable desk lamp that provides bright and focused lighting.",
        ...
        },
        {
            ...
            price: 29.99,
            description: "A compact speaker with powerful sound and wireless connectivity.",
        ...
        },
        {
            ...
            name: "Water Bottle",
            price: 12.49,
            description: "A durable reusable water bottle for staying hydrated all day.",
        ...
        },
        {
            ...
            name: "Laptop Sleeve",
            price: 15.99,
            description: "A padded sleeve designed to protect your laptop during travel.",
        ...
        },
        {
            ...
            price: 18.99,
            description: "A fast wireless charging pad compatible with most smartphones.",
